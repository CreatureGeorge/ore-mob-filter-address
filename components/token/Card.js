export default function Card({ token, setShowModal, setCurToken }) {
  ...
  return (
    <a className="group w-full h-full ease-in duration-300 relative cursor-pointer" onClick={podClick}>
      <div className="grid object-contain place-items-center border-2 rounded-lg transition-all duration-300 ease-in-out md:group-hover:scale-105 overflow-hidden">
        ...
        <div className="flex col-start-1 col-end-2 row-start-1 row-end-2 z-0 bg-white-100 bg-opacity-0 w-full aspect-square rounded-lg" />
        <img src={imgPath} fill="true" className="col-start-1 col-end-2 row-start-1 row-end-2 z-10" />
      </div>
