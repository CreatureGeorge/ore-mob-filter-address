...
import cardanoScanIcon from "../../public/images/links/cardanoscan.png"
...
const resetModal = async () => {
  setShowModal(false)
  setShowInfo(false)
  // await router.push(`/pods`, `/pods`, { shallow: true })
...
const externalLinks = () => {
  ...
  return (
    <div className="flex-none grid grid-flow-col truncate gap-x-1 max-h-[40px]">
      <a className="bg-chinese-black-25 rounded-lg font-roboto px-2 py-2 flex max-h-[35px] items-center gap-x-1" href={`${cnftJungleLink}`} target="_blank" rel="noopener noreferrer">
        <div className="relative aspect-square h-full">
          <Image src={cnftjungleIcon} fill />
        </div>
        <p className="text-white font-bold text-[0px] sm:text-xs">CNFT<span className="font-normal text-xs">Jungle</span></p>
        <div className="relative aspect-square h-0 sm:h-full ml-auto">
          <Image src={externalIcon} fill />
        </div>
      </a>
      <a className="bg-chinese-black-25 rounded-lg font-roboto px-2 py-2 flex max-h-[35px] items-center gap-x-2" href={`${cardanoScanLink}`} target="_blank" rel="noopener noreferrer">
        <div className="relative aspect-square h-full">
          <Image src={cardanoScanIcon} fill />
        </div>
        <p className="text-white font-normal text-[0px] sm:text-xs">Cardano<span className="font-bold text-xs">scan</span></p>
        <div className="relative aspect-square h-0 sm:h-full ml-auto">
          <Image src={externalIcon} fill />
        </div>
      </a>
